  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">Track all your buyer orders and their status.</p>
      </div>
      ...
      <div className="scrollbar-hide -mx-4 mb-5 flex gap-2 overflow-x-auto px-4 sm:mx-0 sm:px-0">
        {filterOptions.map((opt) => {
          ...
          return (
            ...
            >
              {opt} {count > 0 && <span className="opacity-60">({count})</span>}
            </button>
          );
        })}
      </div>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          title={`No ${filter === 'All' ? '' : filter.toLowerCase() + ' '}orders`}
          description={
            filter === 'All'
